...
<div class="submit_cont">
    ...
    <div class="submit_form">
        ...
        <h2 class="submit_header">Изменение статьи про группу &laquo;<?= $band->name?>&raquo;</h2>
        ...
        <input type="hidden" name="id" value="<?= $band->id?>">
            ...
            <div>
                ...
                <input type="text" name="name" class="submit_name" value="<?= $band->name?>">
            </div>

            <div>
                <label for="descr_main">Основной текст статьи</label>
                <textarea name="descr_main" class="submit_descr" rows="4"><?= $band->descr_main?></textarea>
            </div>

            <div>
                <label for="descr_add">Дополнительный текст статьи</label>
                <textarea name="descr_add" class="submit_descr" rows="4"><?= $band->descr_add?></textarea>
            </div>
            ...
            <img src="/img/<?= $band->image ?>" alt="" id="loadImage" class="loadingImage">
