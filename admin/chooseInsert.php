...
<div class="btns" style="background-image: url('/img/<?= $admin->image?>');">
    <div class="btns_block">
        ...
        <a class="adm_btn" href="/subcategs/new.php">Добавить статью в раздел &laquo;Подкатегории&raquo;</a>
        <a class="adm_btn" href="/bands/new.php">Добавить статью в раздел &laquo;Группы&raquo;</a>
